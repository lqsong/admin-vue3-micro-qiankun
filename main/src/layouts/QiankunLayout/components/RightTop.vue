<template>
  <div id="qiankunlayout-right-top" :class="{
    'fiexd': headFixed,
    'narrow': collapsed,
    'tabNavEnable': !tabNavEnable,
    'navModeHorizontal': navMode==='horizontal'
    }">
    <div class="qiankunlayout-right-top-header">
      <div v-if="navMode==='vertical'" class="qiankunlayout-right-top-top">
          <div @click="toggleCollapsed" class="qiankunlayout-flexible">
            <icon-svg v-if="collapsed" type="menu-unfold"></icon-svg>
            <icon-svg v-else type="menu-fold"></icon-svg>
          </div>
          <div class="qiankunlayout-top-menu">
              <div>
                  <bread-crumbs class="breadcrumb" :list="breadCrumbs"></bread-crumbs>
              </div>
          </div>
          <div class="qiankunlayout-top-menu-right">

              <right-top-message />

              <right-top-user />

              <select-lang class="qiankunlayout-top-selectlang" />
      ...
      <div v-else class="qiankunlayout-right-top-top menu">
          <div class="qiankunlayout-right-top-logo">
              <router-link to="/" class="logo-url">
                  <img alt="" src="../../../assets/images/logo.png" width="30">
                  <h3 class="logo-title">Admin Vue3 Micro</h3>
              </router-link>
          </div>
          <div class="qiankunlayout-top-menu">
              <sider-menu
