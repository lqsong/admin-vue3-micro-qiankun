import { useRouter, RouteQueryAndHash, LocationAsPath, RouteLocationOptions, NavigationFailure } from 'vue-router';
import useParentMainRouter from '@/composables/useParentMainRouter';

export declare type RouteLocationRawRest = string | (RouteQueryAndHash & LocationAsPath & RouteLocationOptions);
